...
func main() {
	...
	flag.StringSliceVar(&allowedCIDRs, "allowed-cidrs", []string{},
	"List of CIDR ranges allowed to use for External IPs in the service spec.")
	flag.StringSliceVar(&allowedIPs, "allowed-ips", []string{}, "List of IPs allowed as External IPs in the service spec.")
	flag.Parse()
	...
	serviceValidator, err := validator.NewServiceValidator(allowedIPs, allowedCIDRs)
	if err != nil {
